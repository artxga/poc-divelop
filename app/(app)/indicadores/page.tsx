    ...
    <div className="space-y-6">
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="max-w-lg bg-card border-border/50">
          <DialogHeader>
            <DialogTitle>{editTarget ? "Editar Indicador" : "Nuevo Indicador"}</DialogTitle>
            <DialogDescription>
              {editTarget ? "Modifica los datos del indicador existente." : "Define un nuevo indicador para la biblioteca."}
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={saveIndicador}
              disabled={!form.nombre || !form.codigo}
            >
              {editTarget ? "Guardar cambios" : "Crear indicador"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
