...
export function IndicatorsPage() {
  ...
  function saveIndicator(form: Omit<Indicator, "id">) {
    if (editTarget) {
      setIndicators((prev) =>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {STANDARDS.filter((e) => e !== "Manual").map((est) => {
          const cfg = STANDARD_CONFIG[est as keyof typeof STANDARD_CONFIG];
          return (
            <div
              key={est}
          ...
          <Table>
            ...
            <TableBody>
              {filteredIndicators.map((ind) => {
                const estCfg = STANDARD_CONFIG[ind.standard as keyof typeof STANDARD_CONFIG] || STANDARD_CONFIG.Manual;
